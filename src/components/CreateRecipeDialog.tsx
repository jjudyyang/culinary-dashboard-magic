...
export const CreateRecipeDialog = ({ open, onOpenChange }: CreateRecipeDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-orange-50 to-amber-50">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-orange-800 flex items-center gap-2">
            🍳 Create Your Masterpiece
          </DialogTitle>
          <p className="text-orange-600 italic">"Cooking is not about convenience" - Gordon Ramsay</p>
        </DialogHeader>

        <div className="space-y-6 py-4">
          {/* Recipe Title */}
          <div className="space-y-2">
            <Label htmlFor="title" className="text-orange-800 font-medium">Recipe Title</Label>
            <Input
              id="title"
              value={title}
          ...
          {/* Image Upload */}
          <div className="space-y-2">
            <Label htmlFor="image" className="text-orange-800 font-medium">Recipe Image</Label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-orange-800 font-medium">Cuisine Type</Label>
            ...
            <div className="space-y-2">
              <Label className="text-orange-800 font-medium">Cooking Duration</Label>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label className="text-orange-800 font-medium">Ingredients</Label>
              <Button
                type="button"
                variant="outline"
                size="sm"
                ...
                <div key={index} className="flex gap-2">
                  ...
                  {ingredients.length > 1 && (
                    <Button
                      ...
                      className="border-orange-200 hover:bg-red-50"
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  )}
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label className="text-orange-800 font-medium">Cooking Instructions</Label>
              <Button
                type="button"
                variant="outline"
                size="sm"
                ...
                <div key={index} className="flex gap-2">
                  ...
                  {instructions.length > 1 && (
                    <Button
                      ...
                      className="border-orange-200 hover:bg-red-50 self-start mt-2"
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  )}
